...
def test_models_and_settings(api_token=None):
    """
    This procedure tests selected LLM models and their temperatures.
    :param api_token: API token used for communication with LLM
    :return: None
    """
...
def analyze_result_json(file_path="results.jsonl"):
    """
    This procedure analyzes answers from a REST API endpoint communicating with LLM
    and stored inside a JSON file.
    :param file_path: path to JSON file with responses from the REST API endpoint
    :return: None
    """
...
def check_adherence(human_explanation):
    """
    This function checks whether human explanation generated by LLM adheres to formatting instructions.
    :param human_explanation: explanation obtained from LLM
    :return: True if adhering to instructions, False otherwise
    """
...
def check_correctness(json_line):
    """
    This function checks correctness of results obtained from LLM.
    :param json_line: dictionary representing answer obtained from the REST API
